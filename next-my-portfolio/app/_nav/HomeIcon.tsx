...
const CpuIcon = forwardRef<CpuIconHandle, CpuIconProps>(
  ({ onMouseEnter, onMouseLeave, className, size = 24, ...props }, ref) => {
    ...
    return (
      <div
        className={cn(
          `cursor-pointer select-none p-2 hover:bg-gradient-to-br from-blue-200 to-violet-400
                    dark:from-amber-400 dark:to-red-800 rounded-md transition-colors duration-300 flex items-center justify-center`,
          className
        )}
